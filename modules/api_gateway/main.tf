...
resource "aws_api_gateway_deployment" "this" {
  ...
  triggers = {
    redeployment = sha1(join("", [
      ...
      jsonencode(aws_api_gateway_method.get_daily_coffee),
      jsonencode(aws_api_gateway_integration.get_daily_coffee),
      jsonencode(aws_api_gateway_method.opt_daily_coffee),
      jsonencode(aws_api_gateway_integration.opt_daily_coffee)
    ]))
  }
